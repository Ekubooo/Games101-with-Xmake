...
namespace rst
{
    ...
    private:
        ...
        // --------------------------------------------- 
        void MSAA_triangle(const Triangle &t, const std::array<Eigen::Vector3f, 3> &view_pos);
        void superSample2x2(const float &x, const float &y, const Triangle &t, const std::array<Eigen::Vector3f, 3> &view_pos);
        // ---------------------------------------------
    ...
    private:
        ...
        std::vector<float> depthSample;
        std::vector<Eigen::Vector3f> colorSample;
